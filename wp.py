...
print(""" \033[36;2m
HEYO BRUTE FORCE INDONESIA 
""")
print('___________________________________________________')
print("""
\033[36;1mTOOLS \033[32;1mBRUTEFORCE WP V.2.3\033[35;1m By udu.H-Ck3r \n""")
#
#PAGE 
#
if len(sys.argv) <= 1:
    ...
    print 'Cara Pakai: python2 namascript.py -h https://test.com/wp-login.php -u admin -P listpassword.txt'
    sys.exit()
